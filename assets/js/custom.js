...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensure popover remains visible if hovering over it directly
...
document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('popoverButton2');
...
// popover 3
document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('popoverButton3');
...
// popover4
document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('popoverButton4');
    const popover = document.getElementById('popover4');
...
// popover5
document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('popoverButton5');
    const popover = document.getElementById('popover5');
...
// popover6
document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('popoverButton6');
    const popover = document.getElementById('popover6');
